...
```{r AvgDailyActivypattern,echo=TRUE}
par(mfrow=c(1,1))
plot(mean_steps_per_interval, aes(interval, steps), type="l"
     ,xlab="5 Minute Interval of the Day"
     ,col="blue"
...
```{r PanelPlotWeekDayWeekEnd, echo=TRUE}
par(mfrow=c(2,1)) # divide window into 2
...
```{r DeltaPatternWeekEndWeekDay,echo=TRUE}
...
```{r TotalStepsPerTimeInterval,echo=TRUE}
